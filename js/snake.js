    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<a href='http://www.hackuci.com' class='waves-effect waves-light btn-large apply-btn btn-animate amber darken-2 scroll-link'>Back to HackUCI</a>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Zot The Ant<p></p>Game Over :(<p></p>";
            var tryAgainStart = document.createElement("button");
            tryAgainStart.className = "waves-effect waves-light btn-large apply-btn btn-animate amber darken-2 scroll-link";
        ...
        */ 
        me.setupPlayingField = function () {
            ...
            if (config.fullScreen === true) {
                ...
                document.body.style.backgroundColor = "#010e1e";
            } else {
                cTop = config.top;
                cLeft = config.left;
                cWidth = config.width;
