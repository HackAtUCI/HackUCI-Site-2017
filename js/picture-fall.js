...
var image="http://www.uci.edu/img/50th-logo.png";  //Image path should be given here
...
for (i = 0; i < no; ++ i) {
	...
	document.write("<div id=\"dot"+ i +"\" class=\"raining-img\" style=\"POSITION: absolute; Z-INDEX: "+ i +"; TOP: 15px;LEFT: 15px;\"><img src='"+image+"' border=\"0\"><\/div>");
}
